...
export C_OPTS="-march=x86-64 -mtune=generic -Wno-declaration-after-statement -Wno-implicit-function-declaration -Wno-int-conversion -DANDROID_SUPPORT_FLEXIBLE_PAGE_SIZES=ON"
